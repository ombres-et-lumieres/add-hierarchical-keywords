...
function ol_modify_attachment_datas($data, $id)
{
	...
	$author = isset($xmp["Owner Name"]) ? $xmp["Owner Name"] : $xmp ["Creator"][0];
	...
	$credit = (("" == $credit) and isset($img_exif["COMPUTED"]["Copyright"])) ? $img_exif["COMPUTED"]["Copyright"] :  "";
	$credit = (("" == $credit) and isset($img_exif["IFD0"]["Copyright"])) ? $img_exif["IFD0"]["Copyright"] :  "";
	$credit = (("" == $credit) and isset($iptc["2#116"]) and is_array($iptc["2#116"])) ? $iptc["2#116"][0] :  null;
	...
	$gps = isset($exif["GPS"]) ? $exif["GPS"] : null;
